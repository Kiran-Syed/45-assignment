...
var jungli = ["Cow", "Cat", "Rabbit"];
jungli.forEach(function (oneJungli) {
    var compare = petAnimals.some(function (peto) { return peto.toLowerCase() === oneJungli.toLowerCase(); });
    if (compare) {
        console.log("this ".concat(oneJungli, " is taken"));
    }
    else {
        console.log("This ".concat(oneJungli, " is available"));
    }
});
// //  using for-of-loops FOR EACH ANIMALS
